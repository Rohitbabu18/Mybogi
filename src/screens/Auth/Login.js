    ...
    <View style={style.container}>
      ...
      <View
        ...
        <FbGoogleBox
          ...
          title={'Facebook'}
          imageUri={
            'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT9hiqOg5qjyX7lcEKNZffnegjGJ-cHtnQB3g&usqp=CAU'
          }
        />
        <FbGoogleBox
          marginEnd={0}
      ...
      <Text style={style.alreadyReg}>Already registered?</Text>
      <TouchableOpacity
        activeOpacity={0.5}
        style={style.loginRegMobile}
        onPress={() => {
          navigation.navigate('ExploreBhandaraStore');
        }}>
